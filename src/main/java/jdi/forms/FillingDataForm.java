...
public class FillingDataForm extends Form<MetalsColorsDataSet> {
    ...
    @Override
    public void submit(MetalsColorsDataSet data) {
        ...
        stream(data.getVegetables()).filter(dataVegetable -> !"Vegetables".equals(dataVegetable)).forEach(dataVegetable -> vegetable.select(dataVegetable));
