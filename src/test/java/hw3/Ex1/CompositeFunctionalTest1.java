...
public class CompositeFunctionalTest1 extends CompositeBaseTest {
    ...
    public void functionalTest() {
        ...
        int actualCountOfLeftSideMenu = homePage.counItemsInLefSectionMenu();
        int expectedCountOfLeftSideMenu = 5;
        softAssert.assertEquals(actualCountOfLeftSideMenu, expectedCountOfLeftSideMenu);
    }
